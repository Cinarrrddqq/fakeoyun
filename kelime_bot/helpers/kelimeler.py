...
kelimeler = ["gözəl ","beyin","sual","sağlam ","buraxmaq","zaman","su","eləmək","döymək","olmaq","ölmək",
             ...
             'bağlamaq', 'cırmaq','yatmaq', 'oyun', 'söz', 'əsmək', 'bağlı', 'burda', 'oğurlamaq', 'mahir', 'qiymət', 'doğru', 'pomidor', 'əşya', 'evli','divan', 'girmək', 'imtahan', 'qələm', 'dəftər', 'kitab', 'qaçmaq', 'pubg', 'inanmaq', 'uduzmaq', 'udmaq', 'sevmək', 'əymək', 'qucaqlamaq','yemək', 'şirin', 'qoyun', 'eynək', 'video','etmək', 'dağıdmaq', 'qarabağ', 'qaçmaq', 'siyahı', 'qəpik', 'təəccüb', 'ehtiyac', 'ehtiyat', 'mahnı', 'ibtidai', 'rol', 'oğru'
             ]
